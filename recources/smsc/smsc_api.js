...
var send = function (type, data, clb) {
...
var send_sms = function (data, clb) {
	if (typeof data !== 'object') data = {};
	read_url({
		file : 'send.php',
		data : data
...
var get_status = function (data, clb) {
	if (data.phones) {
...
var get_sms_cost = function (data, clb) {
	if (typeof data !== 'object') data = {};
...
// Запрос к API
var raw = function (file, data, clb) {
	read_url({
		file : file,
		data : data
	}, clb);
...
export { configure, test, send_sms };